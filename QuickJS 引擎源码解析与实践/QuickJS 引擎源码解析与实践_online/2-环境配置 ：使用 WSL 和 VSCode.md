...
![wsl_install.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/decd8f940377438baf4e9a331b1a0321~tplv-k3u1fbpfcp-watermark.image?)
...
![ubuntu.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2de7363745d14a0e8fb3ce8392a93100~tplv-k3u1fbpfcp-watermark.image?)

打开程序后会继续剩余的 WSL 安装工作，耐心等待后会提示我们为子系统创建一个新用户：

![ubuntu_new_user.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/821eaa9e97c346848e9268097452ce29~tplv-k3u1fbpfcp-watermark.image?)

输入用户名密码之后，会看到安装成功并进入子系统的界面：

![ubuntu_ok.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/be509f12a5174fbabdb279b53873f90b~tplv-k3u1fbpfcp-watermark.image?)

首次进入子系统，我们可以运行命令 `sudo apt update` 来更新一下本地软件仓库中的软件版本信息：

![apt_update.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6b03e48fadfe4f2fbefce3a8f9cb983e~tplv-k3u1fbpfcp-watermark.image?)

接着使用命令 `sudo apt upgrade` 升级一下系统中已经安装的软件的版本：

![apt_upgrade.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/49c5c9149a9b41dd8a3a0585630c1228~tplv-k3u1fbpfcp-watermark.image?)

这样我们的 WSL 就算是安装完毕了，最后我们可以将 Ubuntu 程序固定到任务栏：

![ubuntu_pin.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/828391c0c4d94cd7a62b05bedbf1d5f2~tplv-k3u1fbpfcp-watermark.image?)
...
![lsb_release.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0b39897cf842437cb0a4ccbc62fe71e0~tplv-k3u1fbpfcp-watermark.image?)

> 如果软件安装失败，可将系统版本号与错误信息相结合，利用 Google 搜寻解决方式

接着我们运行命令 `sudo apt install clang lld ninja-build clangd`：

![install_clang.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4ef214d7534b44278e6d9a2dce3a6be2~tplv-k3u1fbpfcp-watermark.image?)
...
![cmake_preset.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/42b710337bbf448f92a59f4cab8fb855~tplv-k3u1fbpfcp-watermark.image?)
...
![qjs_help.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e13fe4f7296a432bab62fe2ae84fc861~tplv-k3u1fbpfcp-watermark.image?)
...
![hello_from_qjs.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a01e43a47b9846678c00b21ca35a7350~tplv-k3u1fbpfcp-watermark.image?)
...
![vscode_wsl.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/55f96ae382a4491fb8b882a6c389e12d~tplv-k3u1fbpfcp-watermark.image?)
...
![vscode_code](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1dbecbcf3ca74bbbb2acb27fefdc06ca~tplv-k3u1fbpfcp-watermark.image?)
...
![vscode_wsl_first.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/224ff81c7ab24a12b485bde2a38c6650~tplv-k3u1fbpfcp-watermark.image?)
...
![vscode_ok.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/43ed13730a924d3eb3d098d85a7611f9~tplv-k3u1fbpfcp-watermark.image?)
