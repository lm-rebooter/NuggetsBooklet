...
![heap_dump_demo.gif](img/22/1.png)
导入后的界面内容如下：


![heap_dump.png](img/22/2.png)
...
![list_add_tail.png](img/22/5.png)
...
![dev_tools_distance.png](img/22/7.png)
...
![image.png](img/22/9.png)

载入后会看到类似下面的效果：

![image.png](img/22/10.png)
