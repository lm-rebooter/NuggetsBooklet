...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-1.png)

那就用现在的数据库，如何保证面对大量并发请求的时候，服务不崩呢？

答案就是消息队列，比如常用的 RabbitMQ：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-2.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-3.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-4.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-5.png)

这个版本是有 web 管理界面的。

点击 run：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-6.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-7.png)

就可以在浏览器访问 http://localhost:15672 了：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-8.png)

这就是它的 web 管理界面。

输入 guest、guest 进入管理页面：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-9.png)
...
npm init -y
```
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-10.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-11.png)

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-12.png)

之后就可以在管理界面看到这个队列了：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-13.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-14.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-15.png)
...
node ./src/producer.js
```
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-16.png)

消息消费端：
```
node ./src/consumer.js
```
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-17.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-18.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-19.png)

这就是通过 direct 交换机发送消息的过程。

在管理页面上也可以看到这个交换机的信息：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-20.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-21.png)

可以看到，两个消费者分别收到了不同 routing key 对应的消息。

当然，在管理界面这里也是可以发消息的：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-22.png)

消费者端同样可以收到：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-23.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-24.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/152-25.png)
