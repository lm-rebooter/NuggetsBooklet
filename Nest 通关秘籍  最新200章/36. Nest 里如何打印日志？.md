...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-1.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-2.png)

会打印这样的日志：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-3.png)

这里的 verbose、debug、log、warn、error 就是日志级别，而 \[] 中的是 context，也就是当前所在的上下文，最后是日志的内容。

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-4.png)

这个日志是受 Nest 控制的，可以在创建应用的时候指定是否开启：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-5.png)

设置 logger 为 false 之后就没有日志了。

你也可以自己决定输出什么级别的日志：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-6.png)

此外，你还可以自定义日志打印的方式，定义一个实现 LoggerService 接口的类：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-7.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-8.png)

然后现在项目启动就是这样了：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-9.png)

刷新页面打印的日志是这样的：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-10.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-11.png)

这样你没重写的方法就是原来的：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-12.png)

这就是创建应用时 logger 的 3 种取值：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-13.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-14.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-15.png)

通过 @Inject 注入 AppService，并在 log 的时候调用。

现在的日志是这样的：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-16.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-17.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-18.png)

在这个模块里可以直接注入 MyLogger，不用 imports 那个 Module。

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-19.png)

测试下：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-20.png)

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-21.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-22.png)


![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-23.png)

每次 imports 的时候传入不同的配置：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-24.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/36-25.png)
