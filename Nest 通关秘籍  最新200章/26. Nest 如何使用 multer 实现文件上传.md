...
```
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-1.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-2.png)

然后来写前端代码。

之前我们用过这种方式：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-3.png)

就是让 nest 服务支持静态文件的访问。

现在我们换种方式，让 nest 服务支持跨域，再单独跑个 http-server 来提供静态服务：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-4.png)

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-5.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-6.png)

服务端就打印了 file 对象，并且文件也保存到了 uploads 目录：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-7.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-8.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-9.png)

后端收到了上传的 aaa、bbb 的文件：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-10.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-11.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-12.png)

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-13.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-14.png)

在 FileInterceptor 里也是一样：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-15.png)

在 multer 里我们是通过 array 方法来处理多个 file 的字段：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-16.png)

在 FilesInterceptor 里也一样：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-17.png)

另外两个装饰器也是同理：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-18.png)

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-19.png)

而 UploadedFile、UploadedFiles 这些装饰器，只是从 request 中取出处理完的 file、files 等属性作为参数传入 handler：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-20.png)

了解了这些装饰器的原理之后，回头再来看这些文件上传用的装饰器，是不是就很清晰了呢：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-21.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-22.png)

然后访问下：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-23.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-24.png)

可以看到，返回的也是 400 响应，并且 message 说明了具体的错误信息。

而且这个错误信息可以自己修改：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-25.png)

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-26.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-27.png)

在浏览器上传个文件：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/26-28.png)
