...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-1.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-2.png)
...
![i](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-3.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-4.png)

比如 main-out.log 里保存了 main 进程的正常日志，而 main-error.log 里保存了它的报错日志：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-5.png)

我们再跑一个进程试试：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-6.png)

现在有两个进程了，pm2 logs 可以看到这两个进程的日志：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-7.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-8.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-9.png)

我们指定 1k 内存就重启：

    pm2 start xxx --max-memory-restart 1K

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-10.png)

然后在 nest 代码里用超过 1k 的内存：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-11.png)

先把之前的日志清空，使用 pm2 flush 或者 pm2 flush 进程名|id

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-12.png)

确实清空了：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-13.png)

访问下这个 controller：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-14.png)

查看 main 进程的前 100 行日志：

    pm2 logs main --lines 100 

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-15.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-16.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-17.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-18.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-19.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-20.png)

apps 部分就是配置应用的，scripts 就是应用的启动路径：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-21.png)

它可以指定的配置非常多，基本就是命令行有啥选项，这里就有啥属性：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-22.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-23.png)

然后在本地执行 pm2 link xxx xxx，把本地的 pm2 和那个网站关联起来：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-24.png)

再执行 pm2 plus 就会打开 bucket 对应的网页：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-25.png)

可以在线监控你的应用：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-26.png)

下面这些 plus 的功能都是收费的：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-27.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-28.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-29.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-30.png)

把它跑起来：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-31.png)

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-32.png)


![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-33.png)

这个就是 pm2 打印的日志。

你可以在 terminal 使用 pm2 的命令：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/44-34.png)
