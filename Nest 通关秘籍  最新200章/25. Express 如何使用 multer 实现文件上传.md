...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-1.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-2.png)

浏览器访问下：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-3.png)

这时候在 devtools 可以看到 aaa 请求的 body 是多个 boundary 分隔的格式：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-4.png)

而分隔符是在 Content-Type 指定的：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-5.png)

这就是 form-data 的传输格式。

然后去服务端看看：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-6.png)

req.file 可以拿到文件字段，其余非文件字段在 req.body。

并且服务端多了 uploads 目录，下面就保存着我们上传的文件：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-7.png)

单文件上传我们会了，那多文件上传呢？

再添加一个路由处理多文件的上传：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-8.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-9.png)

node 服务的 req.files 接收到了多个文件：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-10.png)

并且 uploads 目录下也多了俩文件：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-11.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-12.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-13.png)

可以看到服务端打印了报错：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-14.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-15.png)

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-16.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-17.png)

服务端收到了 aaa 和 bbb 的文件：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-18.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-19.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-20.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-21.png)

我们用时间戳 Date.now() 加上Math.random() 乘以 10 的 9 次方，然后取整，之后加上原来的文件名。

测试下：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-22.png)

然后浏览器再次上传：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-23.png)

就可以看到目录和文件名都修改了：
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/25-24.png)
