...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-1.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-2.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-3.png)

答案也是需要一个单独的服务来管理，这个服务就是注册中心：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-4.png)
...
这个：
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-5.png)

这个：
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-6.png)

或者这个：
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-7.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-8.png)

它其实是一个 key-value 的存储服务。

k8s 就是用它来做的注册中心、配置中心：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-9.png)

我们通过 docker 把它跑起来。

在 docker desktop 搜索 etcd 的镜像，点击 run:

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-10.png)

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-11.png)

输入容器名，映射 2379 端口到容器内的 2379 端口，设置 ETCD_ROOT_PASSWORD 环境变量，也就是指定 root 的密码。

然后就可以看到 etcd server 的 docker 镜像成功跑起来了：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-12.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-13.png)
...
```
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-14.png)
...
```
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-15.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-16.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-17.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-18.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-19.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-20.png)

确实取到了 etcd server 中的值。

然后在 etcdctl 里 put 修改下 /services/a 的值：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-21.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-22.png)

再 del 试下：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-23.png)
```
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-24.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-25.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-26.png)

当在 etcdctl 里 del 一个服务节点的时候，这里也能收到通知：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-27.png)
```
etcdctl del /services/my_service/instance_2
```

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/142-28.png)
