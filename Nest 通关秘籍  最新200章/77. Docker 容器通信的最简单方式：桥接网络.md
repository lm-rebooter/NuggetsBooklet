...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-1.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-2.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-3.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-4.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-5.png)

然后 nest 的部分我们要改下代码：

修改 AppModule 的代码，改成用容器名来访问：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-6.png)
...
docker build -t mmm .
```
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-7.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-8.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-9.png)

浏览器访问 http://localhost:3000

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-10.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-11.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-12.png)

现在可以通过容器名直接互相访问了：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-13.png)

原理前面讲过，就是 Namespace。

本来是 3 个独立的 Network Namespace：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-14.png)

桥接之后就这样了：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-15.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-16.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-17.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-18.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-19.png)

可以看到，会先 build dockerfile 产生镜像，然后把 3 个镜像跑起来。

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-20.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-21.png)

也拿到了 redis 的 key，说明 redis 服务跑成功了：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-22.png)
...
docker-compose down --rmi all
```
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-23.png)

把 networks 部分注释掉，重新跑：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-24.png)

你会发现它创建了一个默认的 network：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-25.png)

mysql 和 redis 的访问都是正常的：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/77-26.png)
